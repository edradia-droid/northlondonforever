...
if (NL4_IS_RECORD_ROOM) {
  ...
  Promise.resolve()
    .then(()=>loadScript('premier-league-final-squads-2026-27.js?v=20260905-final4'))
...
if(document.getElementById('arsenalPremierLeagueStats') || document.getElementById('arsenalPlayerStats')){
  ...
  data.src='premier-league-final-squads-2026-27.js?v=20260905-final4';
  data.onload=()=>{const s=document.createElement('script');s.src='premier-league-record-room-sync.js?v=20260905-v4';document.head.appendChild(s);};
  data.onerror=()=>{const s=document.createElement('script');s.src='premier-league-record-room-sync.js?v=20260905-v4';document.head.appendChild(s);};

...
function startSharedSync(){
  ...
  loadOnce('record-room-supabase.js?v=20260906-shared3')
    .then(()=>loadOnce('record-room-supabase-bridge.js?v=20260906-shared3'))
    .then(()=>loadOnce('record-room-fresh-browser-hydrate.js?v=20260906-hydrate1'))
